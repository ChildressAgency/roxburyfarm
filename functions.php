...
add_action('wp_enqueue_scripts', 'roxburyfarm_scripts', 100);
function roxburyfarm_scripts(){
  wp_register_script(
    'bootstrap-script', 
  ...
  wp_register_script(
    'roxburyfarm-scripts', 
    get_template_directory_uri() . '/js/roxburyfarm-scripts.js',
    array('jquery'), 
    '', 
    true
  ); 
  ...
  wp_enqueue_script('roxburyfarm-scripts'); 
}

add_action('wp_enqueue_scripts', 'roxburyfarm_styles');
function roxburyfarm_styles(){
  wp_register_style('bootstrap-css', '//maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css');
  wp_register_style('google-fonts', '//fonts.googleapis.com/css?family=Lato:400,700,700i|Roboto:400,700|Taviraj:500,700,700i');
  wp_register_style('fontawesome', '//use.fontawesome.com/releases/v5.1.0/css/all.css');
  wp_register_style('roxburyfarm', get_template_directory_uri() . '/style.css');
  
  wp_enqueue_style('bootstrap-css');
  wp_enqueue_style('google-fonts');
  wp_enqueue_style('fontawesome');
  wp_enqueue_style('roxburyfarm');
}

//add meta to enqueued styles
add_filter('style_loader_tag', 'roxburyfarm_add_css_meta', 10, 2);
function roxburyfarm_add_css_meta($link, $handle){
...
function roxburyfarm_header_fallback_menu(){ ?>
